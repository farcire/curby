...
// Coordinates adjusted to match visible street positions
// Moving significantly NORTH (increasing latitude by ~0.006)
export const mockBlockfaces: Blockface[] = [
  // ===== 19TH STREET (at the TOP of visible area) =====
  ...
  // 19th: Harrison to Bryant - LEGAL (north side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41190, 37.76397], // 19th & Harrison
        [-122.41010, 37.76382], // 19th & Bryant
      ],
    },
    streetName: '19th St',
    side: 'north',
  ...
  // 19th: Harrison to Bryant - LEGAL (south side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41185, 37.76385], // 19th & Harrison (south)
        [-122.41005, 37.76370], // 19th & Bryant (south)
      ],
    },
    streetName: '19th St',
    side: 'south',
  ...
  // 19th: Bryant to Folsom - LEGAL (north side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.41010, 37.76382], // 19th & Bryant
        [-122.40710, 37.76352], // 19th & Folsom
      ],
    },
    streetName: '19th St',
    side: 'north',
  ...
  // 19th: Bryant to Folsom - LEGAL (south side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.41005, 37.76370], // 19th & Bryant (south)
        [-122.40705, 37.76340], // 19th & Folsom (south)
      ],
    },
    streetName: '19th St',
    side: 'south',
  ...
  // 20th: Harrison to Bryant - LEGAL (north side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41100, 37.76287], // 20th & Harrison
        [-122.40920, 37.76272], // 20th & Bryant
      ],
    },
    streetName: '20th St',
    side: 'north',
  ...
  // 20th: Harrison to Bryant - LEGAL (south side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41095, 37.76275], // 20th & Harrison (south)
        [-122.40915, 37.76260], // 20th & Bryant (south)
      ],
    },
    streetName: '20th St',
    side: 'south',
  ...
  // 20th: Bryant to Folsom - LEGAL (north side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.40920, 37.76272], // 20th & Bryant
        [-122.40620, 37.76242], // 20th & Folsom
      ],
    },
    streetName: '20th St',
    side: 'north',
  ...
  // 20th: Bryant to Folsom - LEGAL (south side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.40915, 37.76260], // 20th & Bryant (south)
        [-122.40615, 37.76230], // 20th & Folsom (south)
      ],
    },
    streetName: '20th St',
    side: 'south',
  ...
  // ===== 21ST STREET (at the BOTTOM of visible area) =====
  ...
  // 21st: Harrison to Bryant - LEGAL (north side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41010, 37.76177], // 21st & Harrison
        [-122.40830, 37.76162], // 21st & Bryant
      ],
    },
    streetName: '21st St',
    side: 'north',
  ...
  // 21st: Harrison to Bryant - LEGAL (south side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41005, 37.76165], // 21st & Harrison (south)
        [-122.40825, 37.76150], // 21st & Bryant (south)
      ],
    },
    streetName: '21st St',
    side: 'south',
  ...
  // 21st: Bryant to Folsom - LEGAL (north side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.40830, 37.76162], // 21st & Bryant
        [-122.40530, 37.76132], // 21st & Folsom
      ],
    },
    streetName: '21st St',
    side: 'north',
  ...
  // 21st: Bryant to Folsom - LEGAL (south side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.40825, 37.76150], // 21st & Bryant (south)
        [-122.40525, 37.76120], // 21st & Folsom (south)
      ],
    },
    streetName: '21st St',
    side: 'south',
  ...
  // Bryant: 19th to 20th - LEGAL (west side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41020, 37.76385], // 19th & Bryant (west)
        [-122.40930, 37.76275], // 20th & Bryant (west)
      ],
    },
    streetName: 'Bryant St',
    side: 'west',
  ...
  // Bryant: 20th to 21st - ILLEGAL (west side) 🚫
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.40930, 37.76275], // 20th & Bryant (west)
        [-122.40840, 37.76165], // 21st & Bryant (west)
      ],
    },
    streetName: 'Bryant St',
    side: 'west',
  ...
  // Harrison: 19th to 20th - ILLEGAL (west side) 🚫
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.41200, 37.76400], // 19th & Harrison (west)
        [-122.41110, 37.76290], // 20th & Harrison (west)
      ],
    },
    streetName: 'Harrison St',
    side: 'west',
  ...
  // Harrison: 20th to 21st - ILLEGAL (west side) 🚫
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.41110, 37.76290], // 20th & Harrison (west)
        [-122.41020, 37.76180], // 21st & Harrison (west)
      ],
    },
    streetName: 'Harrison St',
    side: 'west',
  ...
  // Folsom: 19th to 20th - LEGAL (east side) ✅
  {
    ...
    geometry: {
      type: 'LineString',
      coordinates: [
        [-122.40700, 37.76355], // 19th & Folsom (east)
        [-122.40610, 37.76245], // 20th & Folsom (east)
      ],
    },
    streetName: 'Folsom St',
    side: 'east',
  ...
  // Folsom: 20th to 21st - LEGAL (east side) ✅
  {
    ...
    geometry: {
      ...
      coordinates: [
        [-122.40610, 37.76245], // 20th & Folsom (east)
        [-122.40520, 37.76135], // 21st & Folsom (east)
      ],
    },
    streetName: 'Folsom St',
    side: 'east',
